...
#$ -o sgeLogs46            # Where to put the output
...
python /afs/crc.nd.edu/user/n/ndev/DQM_ML/Anomaly-Detection-for-ECAL-DQM/scripts/model_v46.py --model_name v46  --loss_name MSE --opt_name adadelta 
