...
#$ -o sgeLogs17            # Where to put the output
...
python /afs/crc.nd.edu/user/n/ndev/DQM_ML/Anomaly-Detection-for-ECAL-DQM/scripts/model_v17.py --model_name v17  --loss_name binary_crossentropy --opt_name adadelta
