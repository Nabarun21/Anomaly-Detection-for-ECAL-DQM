...
#$ -o sgeLogs45            # Where to put the output
...
python /afs/crc.nd.edu/user/n/ndev/DQM_ML/Anomaly-Detection-for-ECAL-DQM/scripts/model_v45.py --model_name v45  --loss_name MSE --opt_name adadelta 
python /afs/crc.nd.edu/user/n/ndev/DQM_ML/Anomaly-Detection-for-ECAL-DQM/scripts/model_v45.py --model_name v45  --loss_name MSE --opt_name adadelta  --loss_name binary_crossentropy
