...
#$ -o sgeLogs44            # Where to put the output
...
python /afs/crc.nd.edu/user/n/ndev/DQM_ML/Anomaly-Detection-for-ECAL-DQM/scripts/model_v44.py --model_name v44  --loss_name MSE --opt_name adadelta 
