...
python /afs/crc.nd.edu/user/n/ndev/DQM_ML/Anomaly-Detection-for-ECAL-DQM/scripts/model_v25.py --model_name v25  --loss_name MSE --opt_name adadelta 
python /afs/crc.nd.edu/user/n/ndev/DQM_ML/Anomaly-Detection-for-ECAL-DQM/scripts/model_v26.py --model_name v26  --loss_name MSE --opt_name adadelta 
