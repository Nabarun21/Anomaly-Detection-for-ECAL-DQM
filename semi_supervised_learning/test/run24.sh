...
#$ -o sgeLogs2728            # Where to put the output
...
python /afs/crc.nd.edu/user/n/ndev/DQM_ML/Anomaly-Detection-for-ECAL-DQM/scripts/model_v32.py --model_name v32  --loss_name MSE --opt_name adadelta 
python /afs/crc.nd.edu/user/n/ndev/DQM_ML/Anomaly-Detection-for-ECAL-DQM/scripts/model_v33.py --model_name v33  --loss_name MSE --opt_name adadelta 
