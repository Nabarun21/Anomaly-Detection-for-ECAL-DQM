...
#        np.random.shuffle(train_data_list)
        ...
        my_generator=batch_generator(6000,train_data_list,image_type)
        gen_batch_loss_history=[]
        gen_batch_val_loss_history=[]

        logging.info("Training on EB or EE+ images")
        for batch in my_generator:
            autoencoder.fit(batch,batch,epochs=1,batch_size=500,shuffle=True,validation_split=0.25,callbacks=[training_history,early_stopping,checkpoint])
