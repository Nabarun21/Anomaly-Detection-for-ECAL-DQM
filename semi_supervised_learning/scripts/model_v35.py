...
def get_data(file_name,group='EBOccupancyTask_EBOT_rec_hit_occupancy',data_type='good'):
   ...
   ret_array_norm=pre_process(ret_array)
...
if __name__=='__main__':
    ...
    train_data_list=file_list[0:56] #choosing 63 here keeps ~80% of data for testing, rest for training and val, need to automatize this
    val_data_list=file_list[56:63] #choosing 63 here keeps ~80% of data for testing, rest for training and val, need to automatize this
