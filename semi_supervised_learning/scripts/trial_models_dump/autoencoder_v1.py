...
encoder_final=Conv2D(6,(3,3),activation='relu',padding='same',data_format='channels_first')(encoder_layer_3_pooled)
logging.debug(str(encoder_final.shape))

#decoder
decoder_layer_1=Conv2D(8, (3, 3), activation='relu', padding='same',data_format='channels_first')(encoder_final)
...
decoder_layer_4=Conv2D(6, (3, 3), activation='relu', padding='same',data_format='channels_first')(decoder_layer_3_upsampled)
...
for epoch in range(num_epochs):
   ...
   for batch in my_generator:
      autoencoder.fit(batch,batch,epochs=1,batch_size=20,shuffle=True,validation_split=0.25,callbacks=[training_history,early_stopping])
