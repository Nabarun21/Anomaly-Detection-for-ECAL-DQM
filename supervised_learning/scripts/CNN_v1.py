...
if __name__=='__main__':
    ...
    x=Conv2D(8,(4,4),strides=(2, 2), padding='valid',data_format='channels_first',name='convA_4x4_stride2')(x)
    x=LeakyReLU(alpha=0.1)(x)
    logging.debug(str(x.shape))

    x=Conv2D(6,(4,4),strides=(2, 2), padding='valid',data_format='channels_first',name='convB_4x4_stride2')(x)
    x=LeakyReLU(alpha=0.1)(x)
    logging.debug(str(x.shape))
    x=Dropout(0.25)(x)
    x=Flatten()(x)
