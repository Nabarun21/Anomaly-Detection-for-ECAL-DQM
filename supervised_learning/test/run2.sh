...
#pushd results/$wd
#echo $cmd
cd /afs/crc.nd.edu/user/n/ndev/DQM_ML/Anomaly-Detection-for-ECAL-DQM/supervised_learning
echo `pwd`
source set_env.sh

python /afs/crc.nd.edu/user/n/ndev/DQM_ML/Anomaly-Detection-for-ECAL-DQM/supervised_learning/scripts/CNN_v4.py --model_name v4  --loss_name binary_crossentropy 
python /afs/crc.nd.edu/user/n/ndev/DQM_ML/Anomaly-Detection-for-ECAL-DQM/supervised_learning/scripts/CNN_v5.py --model_name v5  --loss_name binary_crossentropy 
