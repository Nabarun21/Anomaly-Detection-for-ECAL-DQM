...
python /afs/crc.nd.edu/user/n/ndev/DQM_ML/Anomaly-Detection-for-ECAL-DQM/supervised_learning/scripts/CNN_v2.py --model_name v2  --loss_name binary_crossentropy 
python /afs/crc.nd.edu/user/n/ndev/DQM_ML/Anomaly-Detection-for-ECAL-DQM/supervised_learning/scripts/CNN_v3.py --model_name v3  --loss_name binary_crossentropy 
