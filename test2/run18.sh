...
#$ -q gpu                # Specify queue
#$ -l hostname="qa-1080ti-008"         # This job is just going to use one GPU card
#$ -N choose_loss               # Specify job name
#$ -o sgeLogs18            # Where to put the output
...
python /afs/crc.nd.edu/user/n/ndev/DQM_ML/Anomaly-Detection-for-ECAL-DQM/scripts/model_v18.py --model_name v18  --loss_name binary_crossentropy --opt_name adadelta 
