...
if __name__=='__main__':
    ...
    #encoder
    x=Conv2D(16,(5,5),padding='same',data_format='channels_first',use_bias=False)(input_img)
    ...
    x=Conv2D(16,(4,4),padding='same',data_format='channels_first',use_bias=False)(x)
    x=BatchNormalization()(x)
    x=LeakyReLU(alpha=0.1)(x)
    x=Dropout(0.2)(x)
    ...
    x=Conv2D(16,(2,2),padding='same',data_format='channels_first',use_bias=False)(x)
    x=BatchNormalization()(x)
    x=LeakyReLU(alpha=0.1)(x)
    x=Dropout(0.15)(x)
    ...
    x=Conv2D(12,(2,3),padding='same',data_format='channels_first',use_bias=False)(x)
    x=BatchNormalization()(x)
    x=LeakyReLU(alpha=0.1)(x)
    x=Dropout(0.1)(x)
    ...
    x=Conv2D(12,(2,2),padding='same',data_format='channels_first',use_bias=False)(x)
    x=BatchNormalization()(x)
    x=LeakyReLU(alpha=0.1)(x)
    x=Dropout(0.1)(x)

    x=Conv2D(16,(2,1),padding='valid',data_format='channels_first',use_bias=False)(x)
    x=BatchNormalization()(x)
    x=LeakyReLU(alpha=0.1)(x)
    x=Dropout(0.15)(x)
    ...
    x=Conv2D(12,(5,5),padding='same',data_format='channels_first',use_bias=False)(x)
    x=BatchNormalization()(x)
    x=Dropout(0.2)(x)
    x=LeakyReLU(alpha=0.1)(x)
    logging.debug(str(x.shape))
