...
if __name__=='__main__':
    ...
    #encoder
    x=Conv2D(4,(5,5),padding='same',data_format='channels_first',use_bias=False)(input_img)
    ...
    x=Conv2D(2,(5,5),padding='same',data_format='channels_first',use_bias=False)(x)
    x=BatchNormalization()(x)
    x=Dropout(0.1)(x)
    x=LeakyReLU(alpha=0.3)(x)
    logging.debug(str(x.shape))
