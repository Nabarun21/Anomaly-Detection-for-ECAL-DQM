...
import autoencoder_v2 as helper_functions
...
def plot_loss_as_metric(loss_list,plot_dir,save_name='autoencoder_v0_adadelta',is_xlog=False,is_ylog=False,x_label='binary cross-entropy loss',y_label='a.u.',train_test='train'):
...
#    ax.ticklabel_format(style='sci', axis='y', scilimits=(0,0))
    if is_xlog and is_ylog:
        ...
        ax.hist(loss_list,range=(x_min,x_max),bins=50)
    ylim=ax.get_ylim()
...
if __name__=="__main__":
    ...
    my_training_data_generator=helper_functions.batch_generator(4,train_data_list)
    ...
    my_test_data_generator=helper_functions.batch_generator(4,test_data_list)
    test_losses=[]
    ...
    plot_loss_as_metric(test_losses,basedir+'/plots',save_name=args.model_name+'_'+args.opt_name,is_ylog=False,train_test='test')
