...
if __name__=='__main__':
    ...
    #encoder
    encoder_layer_1=Conv2D(6,(3,3),activation='relu',padding='same',data_format='channels_first')(input_img)
    ...
    encoder_final=Conv2D(2,(3,3),activation='relu',padding='same',data_format='channels_first')(encoder_layer_1_pooled)
    logging.debug(str(encoder_final.shape))

    #decoder
    decoder_layer_1=Conv2D(2, (3, 3), activation='relu', padding='same',data_format='channels_first')(encoder_final)
    ...
    decoder_layer_2=Conv2D(6, (3, 3), activation='relu', padding='same',data_format='channels_first')(decoder_layer_1_upsampled)
